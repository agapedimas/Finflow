...
-- Funder
INSERT INTO accounts (id, username, displayname, email, phonenumber, wallet_address, invite_code) VALUES 
('funder_01', 'yayasan_finflow', 'Yayasan Finflow', 'admin@finflow.id', '129381832219', '0x_FUNDER_WALLET', 'INV_FUNDER_001');
INSERT INTO accounts_funder (id, type) VALUES ('funder_01', 0);

-- Student 1 (Budi - The Good One)
INSERT INTO accounts (id, username, displayname, email, phonenumber, wallet_address, invite_code) VALUES 
('student_01', 'budi_santoso', 'Budi Santoso', 'budi@student.com', '10291921921','0x_BUDI_WALLET', 'INV_BUDI_001');
INSERT INTO accounts_student (id, balance) VALUES ('student_01', 2500000.00);

-- Student 2 (Siti - The Edge Case)
INSERT INTO accounts (id, username, displayname, email, phonenumber, wallet_address, invite_code) VALUES 
('student_02', 'siti_aminah', 'Siti Aminah', 'siti@student.com', '10299219120','0x_SITI_WALLET', 'INV_SITI_001');
INSERT INTO accounts_student (id, balance) VALUES ('student_02', 150000.00); -- Saldo Kritis!

-- Parent (Pak Santoso - Ayah Budi)
INSERT INTO accounts (id, username, displayname, email, phonenumber, wallet_address) VALUES 
('parent_01', 'santoso_ayah', 'Pak Santoso', 'santoso@parent.com', '21321898918','0x_PARENT_WALLET');
-- LINK Parent ke Budi
...
-- Funding Budi (6 Juta)
INSERT INTO funding (funding_id, funder_id, student_id, total_period_fund, start_date, status) VALUES 
