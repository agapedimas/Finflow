...
('fund-001', 'funder-12345', 'student-54321', 5000000.00, '2025-10-01', 'Active'); -- <<-- Diubah menjadi 'Active'

-- Aturan Budget: (Tidak ada perubahan)
INSERT INTO funding_allocation (allocation_id, funding_id, category_id, monthly_budget, drip_frequency, drip_amount) VALUES
('alloc-001-needs', 'fund-001', 101, 3000000.00, 'Monthly', 3000000.00), 
('alloc-001-wants', 'fund-001', 200, 1000000.00, 'Monthly', 1000000.00), 
('alloc-001-edu', 'fund-001', 300, 1000000.00, 'Monthly', 1000000.00); 
...
('trx-exp-N-001', 'student-54321', 'fund-001', '2025-11-02 12:30:00', 500000.00, 'Expense', 101, 'Belanja bulanan di Supermarket'), 
('trx-exp-N-002', 'student-54321', 'fund-001', '2025-11-05 10:00:00', 300000.00, 'Expense', 101, 'Bayar listrik kosan'), 
('trx-exp-N-003', 'student-54321', 'fund-001', '2025-10-15 10:00:00', 400000.00, 'Expense', 101, 'Belanja bulan lalu (Oktober)'); 

INSERT INTO transactions (transaction_id, student_id, funding_id, transaction_date, amount, type, category_id, raw_description) VALUES
('trx-exp-W-001', 'student-54321', 'fund-001', '2025-11-03 15:00:00', 150000.00, 'Expense', 200, 'Tiket bioskop nonton film baru'); 
...
('trx-exp-E-001', 'student-54321', 'fund-001', '2025-11-04 09:00:00', 600000.00, 'Expense', 300, TRUE, 'Pembayaran Course Data Science'); 

INSERT INTO transactions (transaction_id, student_id, transaction_date, amount, type, category_id, raw_description) VALUES
('trx-inc-001', 'student-54321', '2025-11-01 10:00:00', 1000000.00, 'Income', 1, 'Pembayaran project freelance'), 
('trx-exp-P-001', 'student-54321', '2025-11-05 08:00:00', 35000.00, 'Expense', 100, 'Kopi susu di Starbuck'); 
